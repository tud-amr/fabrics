...
def parse_runtime_arguments(ob_robot: dict) -> dict:
    ...
    for link in collision_links:
        arguments[f'x_ref_dynamic_obst_0_{link}_leaf'] = ob_robot['FullSensor']['obstacles'][0][0]
        arguments[f'xdot_ref_dynamic_obst_0_{link}_leaf'] = ob_robot['FullSensor']['obstacles'][0][1]
        arguments[f'xddot_ref_dynamic_obst_0_{link}_leaf'] = ob_robot['FullSensor']['obstacles'][0][2]
        arguments['radius_dynamic_obst_0'] = ob_robot['FullSensor']['obstacles'][0][3]
