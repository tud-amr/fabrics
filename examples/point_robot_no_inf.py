...
def set_planner(goal: GoalComposition):
    ...
    collision_geometry = "-2*casadi.log(1 + casadi.exp(-100*x+50)) * xdot ** 2"
    # collision_finsler = "1.0/(x**2) * (1 - ca.heaviside(xdot))* xdot**2"
    # collision_finsler = "2*casadi.log(1 + casadi.exp(-10*x+50)) * xdot ** 2"
    collision_finsler = "2*casadi.log(1 + casadi.exp(-100*x+50)) * xdot ** 2"
